...
- **Tools used:** Python and Pandas were used for data loading, cleaning, transformation, grouping, and analysis. Streamlit was used to build the interactive application, while Plotly was used to produce interactive charts.
